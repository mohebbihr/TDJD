...
public abstract class WindowsFile {
	...
	String OutputDbPath;
	String inputPath;
	String discordantPairs;
	
	public WindowsFile(String inputPath,String OutputFilePath,String OutputDbPath,String discordantPairs,short windowSize,short referenceChr,short min_mapq,boolean isReference,short permuteLength) throws Exception{
	...
	public void SeqToBinaryWindow(String subseq, short windowSize, long referenceStartPos, short readStartPos, long recordId, String readName, String referenceName, String readString, boolean isReference){
